...
const ImageGalleryComponent = () => {
  const imageUrls = [
    ...
    'https://a-static.mlcdn.com.br/800x560/carrinho-hot-wheels-batmovel-branco-the-flash-series-mattel/toysteam/027084120134hw-hkj74/642148b43ca5ac22d4c236871f8fde10.jpeg', 'https://http2.mlstatic.com/D_NQ_NP_2X_739485-MLB50373678276_062022-F.webp', 'https://m.media-amazon.com/images/I/81d42rGUMuL._AC_SY879_.jpg', 'https://a-static.mlcdn.com.br/800x560/hot-wheels-the-batman-batmobile-prata-batmovel-mattel-gtb55/toysteam/027084120134hw-gtb55/25d222a8fd6f558d7fe0e9589edfb55c.jpeg', 'https://http2.mlstatic.com/D_NQ_NP_2X_797358-MLB72283791477_102023-F.webp', 'https://http2.mlstatic.com/D_NQ_NP_2X_671365-MLB71943161294_092023-F.webp',/*Até aqui Hot Wheels*/
  ...
  return (
    <ImageGallery>
      {imageUrls.map((url, index) => (
        <ImageItem key={index} src={url} alt={`Image ${index + 1}`} />
      ))}
    </ImageGallery>
  );
};
